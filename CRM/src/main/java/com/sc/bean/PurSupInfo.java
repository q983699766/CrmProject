...
public class PurSupInfo implements Serializable {
	...
	public String toString() {
		return "PurSupInfo [supInfoNum=" + supInfoNum + ", supName=" + supName + ", supUname=" + supUname
				+ ", contacts=" + contacts + ", fixedTel=" + fixedTel + ", telphone=" + telphone + ", fax=" + fax
				+ ", email=" + email + ", openBank=" + openBank + ", bankNature=" + bankNature + ", comIndex="
				+ comIndex + ", effectiveOrnot=" + effectiveOrnot + ", operatorId=" + operatorId + ", remarksInfo="
				+ remarksInfo + ", comId=" + comId + ", lastDate=" + lastDate + ", bankNumber=" + bankNumber + "]";
	}
