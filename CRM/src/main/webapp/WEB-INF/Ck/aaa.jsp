	...
	<tbody>
	 <c:forEach items="${pi.list }" var="u">  
	  <tr>
        ...
        <td width="80px">${u.productId }</td>               
        <td width="250px"><u style="cursor:pointer" class="text-primary" onclick="">${u.spMc }</u></td>
        <td width="100px">${u.spLb }</td>
        <td width="100px">${u.ggSm }</td> 
        <td width="100px">${u.dw }</td>         
        <td width="180px">${u.ckBh }</td>
        <td class="text-l">${u.kcSl }</td>
        <td class="td-status"><span class="label label-success radius">${u.cbj }</span></td>
        <td>${u.lsj }</td>
        <td>${u.jxj }</td>
        <td>${u.bzxx }</td>
        <td>${u.comId }</td>
...
var zNodes =[
	...
	{ id:11, pId:1, name:"音频类"},
	{ id:111, pId:11, name:"蓝牙音响"},
	{ id:112, pId:11, name:"蓝牙耳机"},
	
	{ id:12, pId:1, name:"线材类"},
	{ id:121, pId:12, name:"vivo数据线 "},
	{ id:122, pId:12, name:"oppo数据线 "},
	{ id:122, pId:12, name:"iphone数据线 "},
	{ id:122, pId:12, name:"小米数据线 "},
	
	{ id:13, pId:1, name:"手机壳"},
	{ id:131, pId:13, name:"vivo手机壳 "},
	{ id:122, pId:13, name:"oppo手机壳 "},
	{ id:122, pId:13, name:"iphone手机壳 "},
	{ id:122, pId:13, name:"小米手机壳 "},
