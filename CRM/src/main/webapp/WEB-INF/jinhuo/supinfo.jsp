...
<body>
						...
						<form action="pursupinfo/delall.do" id="cc" method="post">
							<c:forEach items="${pi.list}" var="i">
								<tr>
									...
									<td>${i.remarksInfo}</td>
									<td style="font-size:15px;"><a href="javascript:"
							...
							<tr>
								<td colspan="11" style="text-align: center"><a
									href="pursupinfo/selectinfo.do?pageNum=${pi.navigateFirstPage}">首页</a>
									<a href="pursupinfo/selectinfo.do?pageNum=${pi.prePage }">上一页</a>
									<a href="pursupinfo/selectinfo.do?pageNum=${pi.nextPage }">下一页</a>
									<a
									href="pursupinfo/selectinfo.do?pageNum=${pi.navigateLastPage }">尾页</a>
	...
	<!-- //添加页面 -->
	<form action="pursupinfo/addinfo.do" method="post"
		onsubmit="return yz()">
      ...
      -->
				<li><label class="label_name" style="width: 100px;">供应商名称：</label><span
					class="add_name"><input id="a" name="supName" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">供应商简称：</label><span
					class="add_name"><input id="b" name="supUname" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">联系人：</label><span
					class="add_name"><input id="c" name="contacts" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">固定电话：</label><span
					class="add_name"><input id="d" name="fixedTel" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">移动电话：</label><span
					class="add_name"><input id="e" name="telphone" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">联系传真：</label><span
					class="add_name"><input id="f" name="fax" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
     ...
     <li><label class="label_name" style="width: 100px;">联系邮编：</label><span class="add_name"><input  type="text" name="联系邮编" id="SUP_INFO_NUM"class="text_add"/></span><div class="prompt r_f"></div></li>
      -->
				<li><label class="label_name" style="width: 100px;">邮箱：</label><span
					class="add_name"><input id="g" name="email" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">开户银行：</label><span
					class="add_name"><input id="h" name="openBank" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">银行账号：</label><span
					class="add_name"><input id="i" name="bankNumber" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">公司主页：</label><span
					class="add_name"><input id="j" name="comIndex" type="text"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				...
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">银行性质：</label><span
					class="add_name"><input id="k" name="bankNature"
						type="text" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				...
				<li>状态：<select name="effectiveOrnot" id="l">
	...
	<form action="pursupinfo/updateinfo.do">
		<div class="update_menber" id="update_menber_style"
			style="display:none">
			<ul class=" page-content">
				<input type="hidden" id="supInfoNum2" name="supInfoNum"
					class="text_add" />
				<li><label class="label_name" style="width: 100px;">供应商名称：</label><span
					class="add_name"><input type="text" id="supName2"
						name="supName" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">供应商简称：</label><span
					class="add_name"><input type="text" id="supUname2"
						name="supUname" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">联系人：</label><span
					class="add_name"><input type="text" id="contacts2"
						name="contacts" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">固定电话：</label><span
					class="add_name"><input type="text" id="fixedTel2"
						name="fixedTel" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">移动电话：</label><span
					class="add_name"><input type="text" id="telphone2"
						name="telphone" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">联系传真：</label><span
					class="add_name"><input type="text" id="fax2" name="fax"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
    ...
    -->
				<li><label class="label_name" style="width: 100px;">邮箱：</label><span
					class="add_name"><input type="text" id="email2" name="email"
						class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">开户银行：</label><span
					class="add_name"><input type="text" id="openBank2"
						name="openBank" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">银行账号：</label><span
					class="add_name"><input type="text" id="bankNumber2"
						name="bankNumber" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">账户类型：</label><span
					class="add_name"><input type="text" id="bankNature2"
						name="bankNature" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">公司主页：</label><span
					class="add_name"><input type="text" id="comIndex2"
						name="comIndex" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">备注信息：</label><span
					class="add_name"><input type="text" id="remarksInfo2"
						name="remarksInfo" class="text_add" /></span>
				<div class="prompt r_f"></div></li>
				<li><label class="label_name" style="width: 100px;">公司编号：</label><span
	...
	<div class="update_menber" id="show_menber_style" style="display:none">
		<ul class=" page-content">
			<li><label class="label_name" style="width: 100px;">供应商编号：</label><span
				class="add_name" id="supInfoNum1" name="supInfoNum"> </span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">供应商名称：</label><span
				class="add_name" id="supName1" name="supName"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">供应商简称：</label><span
				class="add_name" id="supUname1" name="supUname"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">联&nbsp;&nbsp;&nbsp;系&nbsp;&nbsp;&nbsp;人：</label><span
				class="add_name" id="contacts1" name="contacts"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">固&nbsp;定&nbsp;电&nbsp;话：</label><span
				class="add_name" id="fixedTel1" name="fixedTel"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">移&nbsp;动&nbsp;电&nbsp;话：</label><span
				class="add_name" id="telphone1" name="telphone"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">联&nbsp;系&nbsp;传&nbsp;真：</label><span
				class="add_name" id="fax1" name="fax"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：</label><span
				class="add_name" id="email1" name="email"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">开&nbsp;户&nbsp;银&nbsp;行：</label><span
				class="add_name" id="openBank1" name="openBank"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">银&nbsp;行&nbsp;账&nbsp;号：</label><span
				class="add_name" id="bankNumber1" name="bankNumber"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">公&nbsp;司&nbsp;主&nbsp;页：</label><span
				class="add_name" id="comIndex1" name="comIndex"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">备&nbsp;注&nbsp;信&nbsp;息：</label><span
				class="add_name" id="remarksInfo1" name="remarksInfo"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">公&nbsp;司&nbsp;编&nbsp;号：</label><span
				class="add_name" id="comId1" name="comId"></span>
			<div class="prompt r_f"></div></li>
			<li><label class="label_name" style="width: 100px;">状&nbsp;&nbsp;&nbsp;&nbsp;态：</label><span
				class="add_name" id="effectiveOrnot1" name="effectiveOrnot"></span></li>
			<li><label class="label_name" style="width: 100px;">账&nbsp;户&nbsp;类&nbsp;型：</label><span
				class="add_name" id="bankNature1" name="bankNature"></span></li>
